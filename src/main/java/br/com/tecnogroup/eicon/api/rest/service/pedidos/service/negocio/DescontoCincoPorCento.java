...
public class DescontoCincoPorCento implements IRegraCalculoDesconto {

    private static final double VALOR_DESCONTO_CINCO = 5.00;
    ...
    public BigDecimal getValorPercentualDesconto(Pedido pedido) {
        return BigDecimal.valueOf(VALOR_DESCONTO_CINCO);
    }
